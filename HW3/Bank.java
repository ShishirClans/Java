...
public class Bank {
	...
	public String[] manages(String fname, String lname, String dob, String address, int pin_1) throws IOException, ParseException {
		checking.setAccount(fname,lname,dob,address,pin_1);
