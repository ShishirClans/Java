...
public class Server {
	...
	public void setApproval(String fname, String lname, String dob, String address, int pin_1) throws IOException, ParseException {

		approvalCode_CardNumber_AccNumber= bank.manages(fname, lname, dob, address, pin_1);
		approvalCode=true;
	}
