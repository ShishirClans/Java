...
In this code I added methods like printNames, addElements, printAll, and printFavoriteLanguages methods.
It meets the function that its name implies.
...
public class ManageEmployees {
    ...
    /**Method for printNames **/
    public static void printNames(ArrayList<? extends Employee> empList) {
        for (Employee e : empList) {
            System.out.println(e.name());
        }
    }

    /** Method for addElements **/
    public static <E> void addElements(ArrayList<E> emp, ArrayList<? super E> emps){
        ...
        /** method for printFavoriteLanguage **/
