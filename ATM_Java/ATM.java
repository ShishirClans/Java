...
public class ATM {
	...
	public String [] transaction(String fname, String lname, String dob, String address, int pin_1) throws IOException, ParseException {

		server.setApproval(fname,lname,dob,address,pin_1);
